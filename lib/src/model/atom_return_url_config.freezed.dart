...
/// Defaults to [AtomConstants.defaultReturnUrl].
 String get returnUrl;/// Determines how the response is handled.
 AtomReturnUrlMode get mode;
...
@useResult
$Res call({
 String returnUrl, AtomReturnUrlMode mode
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String returnUrl,  AtomReturnUrlMode mode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AtomReturnUrlConfig() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String returnUrl,  AtomReturnUrlMode mode)  $default,) {final _that = this;
switch (_that) {
case _AtomReturnUrlConfig():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String returnUrl,  AtomReturnUrlMode mode)?  $default,) {final _that = this;
switch (_that) {
case _AtomReturnUrlConfig() when $default != null:
return $default(_that.returnUrl,_that.mode);case _:
  return null;
...
class _AtomReturnUrlConfig implements AtomReturnUrlConfig {
  const _AtomReturnUrlConfig({this.returnUrl = AtomConstants.defaultReturnUrl, required this.mode});
...
@override final  AtomReturnUrlMode mode;
