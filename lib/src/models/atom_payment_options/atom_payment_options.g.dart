...
_AtomPaymentOptions _$AtomPaymentOptionsFromJson(Map<String, dynamic> json) =>
    _AtomPaymentOptions(
      ...
      mode: $enumDecode(_$AtomEnvEnumMap, json['mode']),
...
Map<String, dynamic> _$AtomPaymentOptionsToJson(_AtomPaymentOptions instance) =>
    <String, dynamic>{
      ...
      'returnUrlConfig': instance.returnUrlConfig?.toJson(),
      'mode': _$AtomEnvEnumMap[instance.mode]!,
...
const _$AtomEnvEnumMap = {AtomEnv.live: 'live', AtomEnv.uat: 'uat'};
